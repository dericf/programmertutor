    ...
    <>
      ...
      <article className="prose mx-auto">
        ...
        <p>
          ...
          use of Programmer Tutor's Website, located at
          https://programmertutor.com.
        </p>

        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use Programmer Tutor if you do not
        ...
        <p>
          ...
          agreed to use cookies in agreement with the Programmer Tutor's Privacy
          Policy.
        </p>
        ...
        <p>
          ...
          intellectual property rights for all material on Programmer Tutor. All
          intellectual property rights are reserved. You may access this from
          Programmer Tutor for your own personal use subjected to restrictions
          set in these terms and conditions.
        </p>

        <p>You must not:</p>
        <ul>
          <li>Republish material from Programmer Tutor</li>
          <li>Sell, rent or sub-license material from Programmer Tutor</li>
          <li>Reproduce, duplicate or copy material from Programmer Tutor</li>
          <li>Redistribute content from Programmer Tutor</li>
        </ul>
        ...
        <p>
          ...
          Programmer Tutor does not filter, edit, publish or review Comments
          prior to their presence on the website. Comments do not reflect the
          views and opinions of Programmer Tutor,its agents and/or affiliates.
          ...
          Programmer Tutor shall not be liable for the Comments or for any
        ...
        <p>
          Programmer Tutor reserves the right to monitor all Comments and to
        ...
        <p>
          You hereby grant Programmer Tutor a non-exclusive license to use,
        ...
        <p>
          ...
          the hyperlink compensates the absence of Programmer Tutor; and (d) the
        ...
        <p>
          ...
          sending an e-mail to Programmer Tutor. Please include your name, your
        ...
        <p>
          No use of Programmer Tutor's logo or other artwork will be allowed for
